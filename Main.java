...
public class Main {
    private static SudokuGame Level_one = new SudokuGame("165 794 038 407 002 050 930 006 004 810 405 002 576 239 400 200 601 075 301 507 849 690 000 527 050 028 103");
    private static SudokuGame usrSudoku;
    ...
    private static int difficulty() {
        ...
        if (usrChoice.equals("1")) {
            System.out.println(Level_one.toString());
            usrSudoku = new SudokuGame(Level_one.getBoardAsString());
        }
